    ...
    if args.do_train:
        ...
        for step in bar:
            ...
            if args.do_eval and ((global_step + 1) % args.eval_steps == 0) and eval_flag:
                ...
                writeCSVLoggerFile(csvLoggerFile_path,training_log)
                ...
                logger.info("  " + "*" * 20)
                bleu_log["step"] = global_step
                bleu_log["Bleu_score"] = dev_bleu
                writeCSVLoggerFile(csvLoggerFile_Blue_path,bleu_log)
